...
class OrganisationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create organisation" do
    assert_difference('Organisation.count') do
      post organisations_url, params: { organisation: { address_id: @organisation.address_id, org_code: @organisation.org_code, org_name: @organisation.org_name } }
    end
  ...
  test "should update organisation" do
    patch organisation_url(@organisation), params: { organisation: { address_id: @organisation.address_id, org_code: @organisation.org_code, org_name: @organisation.org_name } }
